...
func (fs *FileSystem) UploadCroppedImage(ctx context.Context, reader io.Reader, info core.FileInfo, rect CropRect, format string, quality int) (core.FileInfo, error) {
	...
	return fs.UploadStream(ctx, &buf, info)
}

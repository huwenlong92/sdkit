...
This project is indexed by GitNexus as **sdkit** (10519 symbols, 35598 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **sdkit** (10173 symbols, 34586 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

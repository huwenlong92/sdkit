...
type IdentityValidator func(ctx context.Context, identity *Identity, raw any) error
type IdentityRefresher func(ctx context.Context, identity *Identity, raw any) error
...
func (a *SessionAuthenticator) AuthenticateRequest(ctx context.Context, r *http.Request) (*Identity, error) {
	...
	if a.Validator != nil {
		if err := a.Validator(ctx, identity, raw); err != nil {
			return nil, err
		}
	}
	if a.Refresher != nil {
		if err := a.Refresher(ctx, identity, raw); err != nil {
			return nil, err
		}
	}
	return identity, nil
